...
/*   Updated: 2021/02/02 11:00:23 by fportalo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			funky_func_keypress(int keycode, t_raycast *rc)
{
	...
	{
		rc->keys.rotLeft = 1;
		printf("keycode pressed is: Arrow Rotate Left\n");
	}
		if (keycode == 124)
	{
		rc->keys.rotRight = 1;
		printf("keycode pressed is: Arrow Rotate Right\n");
	}
	if (keycode == 53)
	{
...
int			funky_func_keyrelease(int keycode, t_raycast *rc)
{
	...
	{
		rc->keys.rotLeft = 0;
		printf("keycode released is: Arrow Rotate Left\n");
	}
	if (keycode == 124)
	{
		rc->keys.rotRight = 0;
		printf("keycode released is: Arrow Rotate Right\n");
	}
	return(1);
}
